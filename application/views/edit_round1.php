...
<h2>Round 1 Questions</h2>
	...
	<div class='row-fluid'>
		<a href="/user/edit_round1_by_difficulty"><button class="btn">Difficulty</button></a>
		<a href="/user/edit_round1_by_badge"><button class="btn">Badge</button></a>
		<a href="/user/edit_round1_by_question"><button class="btn">Question</button></a>
	</div>
</div>
